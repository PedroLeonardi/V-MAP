...
export default function PageAdmin() {
  ...
  // fazendo requisição para minha api para pegar o total de alunos
  useEffect(() => {
  ...
  return (
    <div className='min-h-screen bg-slate-900 text-gray-100 p-4 sm:p-8 font-sans'>
          ...
          {menu.map((item) => (
            <li key={item.nome}>
              <button
                ...
                className={`
                  flex items-center gap-2 p-3 px-4 rounded-lg
      ...
      {/* aqui eu mexo nas sessões de cada aba */}
      <section>
        {abaAtiva === 'Alunos' ? (
          <>
          ...
          // Placeholder padrão para outras abas (ainda a construir... .. . ..)
