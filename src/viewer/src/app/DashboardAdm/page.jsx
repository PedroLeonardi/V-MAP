...
import ModalMapa from '../Components/MapaRota/MapWrapperAdm'
          ...
          <nav className='mb-10 pb-4 border-b border-slate-700'>
            <div className="flex justify-between items-center flex-wrap gap-y-4">
              ...
              <button
                ...
                className="flex items-center gap-x-2 px-4 py-2 rounded-lg bg-red-600/90 text-white font-semibold hover:bg-red-700 transition-all duration-150 ease-in-out focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2 focus:ring-offset-slate-900"
              >
            ...
            <>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 xl:grid-cols-3 gap-4 sm:gap-5 md:gap-6 ">
                ...
                <DashboardCard
                  cardStyle={cardBaseStyle} iconColor={cardIconColor} titleStyle={cardTitleStyle} descriptionStyle={cardDescriptionStyle} valueStyle={cardValueStyle}
                  icon={<TbNumber size={cardIconSize} />}
                  title="Total de Pontos (Checkpoints)"
                ...
                <DashboardCard
                  cardStyle={`${cardBaseStyle} ${cardActionStyle}`} iconColor={cardIconColor} titleStyle={cardTitleStyle} descriptionStyle={cardDescriptionStyle}
                  icon={<PiListChecksBold size={cardIconSize} />}
                  title="Listar Pontos (Checkepoints)"
              ...
              <div className="mt-8 bg-slate-800/80 border border-slate-700 rounded-xl p-4 shadow-lg">
                <h3 className="text-lg font-semibold text-sky-400 mb-4">Visualização das Rotas</h3>
